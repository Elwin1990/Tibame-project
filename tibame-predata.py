...
def detect(img):
    ...
    try:
        ...
        dic['LEFTELBOW'].append(None)
        dic['RIGHTELBOW'].append(None)
        dic['LEFTSHOULDER'].append(None)
        dic['RIGHTSHOULDER'].append(None)
        dic['LEFTHIP'].append(None)
        dic['RIGHTHIP'].append(None)
        dic['LEFTKNEE'].append(None)
        dic['RIGHTKNEE'].append(None)
...
#     f.write('total frame= ' + str(framenumber) + '   fps= ' + str(fps) + '\n')
#     for i in range(len(test)):
#         f.write('{0:5d}  '.format(i) + str(test[i]) + '\n')